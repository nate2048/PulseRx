...
function ModalTestForm({ label, placeholder, size }) {
  return (
      <div className="flex flex-col items-end gap-6 w-72">
          <div className="relative w-full min-w-[200px] h-10">
              ...
              peer-focus:before:!border-gray-900 after:border-blue-gray-200 peer-focus:after:!border-gray-900"> Type (Optional)
          </label>
          </div>
          <div className="relative w-full min-w-[200px] h-11">
              ...
              after:border-blue-gray-200 peer-focus:after:!border-gray-900"> Source (Optional)
          </label>
